...
namespace CatalogadorArchivos
{
	partial class frmBuscar
	{
		...
		private System.Windows.Forms.CheckBox cbxComentario;
		...
		private void InitializeComponent()
		{
			...
			this.cbxComentario = new System.Windows.Forms.CheckBox();
			...
			// cbxNombre
			// 
			this.cbxNombre.Location = new System.Drawing.Point(12, 56);
			this.cbxNombre.Name = "cbxNombre";
			this.cbxNombre.Size = new System.Drawing.Size(104, 24);
			this.cbxNombre.TabIndex = 15;
			...
			// cbxComentario
			// 
			this.cbxComentario.Location = new System.Drawing.Point(12, 80);
			this.cbxComentario.Name = "cbxComentario";
			this.cbxComentario.Size = new System.Drawing.Size(104, 24);
			this.cbxComentario.TabIndex = 15;
			this.cbxComentario.Text = "Comentario";
			this.cbxComentario.UseVisualStyleBackColor = true;
			// 
			// checkBox4
			// 
			...
			this.txtBuscarPor.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtBuscarPor_KeyPress);
			// 
			// label2
			// 
			...
			this.tabPage1.Controls.Add(this.cbxNombre);
			this.tabPage1.Controls.Add(this.checkBox7);
			this.tabPage1.Controls.Add(this.checkBox4);
			this.tabPage1.Controls.Add(this.cbxComentario);
